...
Control groups using mag_inventory.ini or set environment variables:
...
mag_inventory.ini is included. The name of the .ini file is the basename of the inventory script (in this case
...
class AzureRM(object):
    ...
    def __init__(self, args):
        ...
        if self.credentials.get('client_id') is not None and \
           ...
           self.credentials.get('tenant') is not None:
            ...
            self.azure_credentials = UserPassCredentials(self.credentials['ad_user'], self.credentials['password'], resource="https://management.usgovcloudapi.net/")
        else:
    ...
    def network_client(self):
        ...
        if not self._network_client:
            self._network_client = NetworkManagementClient(self.azure_credentials, self.subscription_id, base_url="https://management.usgovcloudapi.net/")
    ...
    def rm_client(self):
        ...
        if not self._resource_client:
            self._resource_client = ResourceManagementClient(self.azure_credentials, self.subscription_id, base_url="https://management.usgovcloudapi.net/")
    ...
    def compute_client(self):
        ...
        if not self._compute_client:
            self._compute_client = ComputeManagementClient(self.azure_credentials, self.subscription_id, base_url="https://management.usgovcloudapi.net/")
